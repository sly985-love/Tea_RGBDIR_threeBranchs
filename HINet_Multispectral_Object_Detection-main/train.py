...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/MHT/yolov5s_fusion_apple_dct.yaml', help='model.yaml path')
    ...
    parser.add_argument('--epochs', type=int, default=500)  # 2000
    ...
    parser.add_argument('--project', default=r'/home/ps/rgbd/result/HINet', help='save to project/name')
    # parser.add_argument('--project', default='runs/train', help='save to project/name')
    parser.add_argument('--entity', default=None, help='W&B entity')
    parser.add_argument('--name', default='sa_RGB_IR', help='save to project/name')
